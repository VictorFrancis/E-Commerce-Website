<!DOCTYPE html>
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/menhub.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
    ...
    <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">Shirt & T-shirt</h4>

    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/shirt1.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
          ...
          <div class="col-md-4">
              <img src="productimage/shirt2.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
          ...
          <div class="col-md-4">
              <img src="productimage/shirt3.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/limit1.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
    ...
    <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">Pant's & Trousers</h4>

    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/pant1.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/pant2.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 30px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/pant3.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/featured.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
    ...
    <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">Shoes</h4>

    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/shoe1.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/airjordan.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 30px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/casualshoes.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
