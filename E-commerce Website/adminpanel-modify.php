...
<!DOCTYPE html>
  ...
  <section>
    <!--------------------------------Footer------------------------------------->
    <div class="container" style="position: relative; right: 60px; top: 50px;">
      <h1>Modify Product</h1>
      <br>
      <form action="modifyproduct.php" method="POST">
        <div class="form-group">
          <label for="name">Old Name</label>
          <input name="oname" type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Name">
        </div>
        <div class="form-group">
          <label for="name">Name</label>
          <input name="pname" type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Name">
        </div>
        <div class="form-group">
          <label for="name">Description</label>
          <input name="pdes" type="text" class="form-control" id="des" aria-describedby="emailHelp" placeholder="Name">
        </div>
        <div class="form-group">
          <label for="name">Photo URL</label>
          <input name="purl" type="text" class="form-control" id="url" aria-describedby="emailHelp" placeholder="Photo URL">
        </div>
