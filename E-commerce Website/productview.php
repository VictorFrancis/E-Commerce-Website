...
<!DOCTYPE html>
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container" style="position: relative; top: 50px; right: 65px;">
      
      <br>
      <div class="row">
        <div class="col-md-6">
          <img src="productimage/airjordan.jpg" alt="..." class="img-thumbnail" style="">
        </div>
        <div class="col-md-6">

          <h4 style="font-family: Georgia;">Nike Air Jordan</h4>
          <br>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
          </p>
          <br>
          <div class="img-thumbnail" style="background-color: rgb(169,169,169); max-width: 20%; height: 40px;">
            <p style=" font-weight: bold; position: relative; top: 2px; left: 23px; max-width: 20%; height: 40px;">$15.99</p>
            <a href=""><i class="fas fa-3x fa-cart-plus" style="color: black; position: relative; left: 150px; bottom: 70px;"></i></a>
  ...
  <h4 style="padding-left: 50px; padding-top: 100px; font-family: Georgia;">Custom Order</h4>
  <br>
