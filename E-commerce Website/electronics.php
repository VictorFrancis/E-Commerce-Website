  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">Electronics</h4>

    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/ps5.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/echo.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
          ...
          <div class="col-md-4">
              <img src="productimage/charger.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
          ...
          <div class="col-md-4">
              <img src="productimage/vga.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/headphone.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/lock.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/headphone2.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 30px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/receiver.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/camera.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/iphone.png" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/laptop.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 30px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/laptop2.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
