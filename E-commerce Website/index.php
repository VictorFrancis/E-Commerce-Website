  ...
  <!--------------------Item Contents------------------------------------------------>
  <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">New Electronics</h4>
  <div class="container-fluid">
	...
	<h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">New Men's Fashion</h4>
  ...
  <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">New Gifts & Gadgets</h4>

  <div class="container-fluid">
		<div class="row">
		    <div class="col-xl-md">
		      	<img src="productimage/makeup.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
		      	<div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
			      	<form action="productview.php">
				      	<button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
				  			Shop
	...
	<h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">New Health & Beauty</h4>
  ...
  <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">New Women's Fashion</h4>
