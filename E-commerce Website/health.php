  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <h4 style="padding-left: 50px; padding-top: 50px; font-family: Georgia;">Health & Beauty</h4>

    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/health.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/health2.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
          ...
          <div class="col-md-4">
              <img src="productimage/health3.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
          ...
          <div class="col-md-4">
              <img src="productimage/health4.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/health7.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/shades.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/protein.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 30px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/makeupbursh.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
  ...
  <!--------------------Content------------------------------------------------------------->
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-xl-md">
              <img src="productimage/medicine.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 50px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 80px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-4">
              <img src="productimage/medicine2.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/medicine3.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-right: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 30px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
          ...
          <div class="col-md-4">
              <img src="productimage/medicine4.jpg" class="img-fluid" style="width: 1300px; height: 500px; padding-left: 30px; padding-top: 50px;">
              <div class="shop-button" style="position: relative; left: 50px; bottom: 90px;">
                <form action="productview.php">
                  <button type="submit" class="btn btn-default btn-rounded" style="border-radius: 20px;">
                  Shop
